...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/shared/:tripId" element={<Shared />} />
      ...
      >
        ...
        <Route path="explore/cities/:cityId" element={<DestinationDetail />} />
        <Route
          path="explore/activities/:activityId"
          element={<ActivityDetail />}
        />
        <Route path="profile" element={<Profile />} />
      </Route>
      <Route
        path="/explore/cities/:cityId"
        element={
          <Guard>
            <DestinationDetail />
          </Guard>
